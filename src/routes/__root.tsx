...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "MedRoster — Hospital Roster Management" },
      { name: "description", content: "Calm, friendly roster management for hospital teams." },
      { property: "og:title", content: "MedRoster — Hospital Roster Management" },
      { name: "twitter:title", content: "MedRoster — Hospital Roster Management" },
      { property: "og:description", content: "Calm, friendly roster management for hospital teams." },
      { name: "twitter:description", content: "Calm, friendly roster management for hospital teams." },
