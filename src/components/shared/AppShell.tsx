...
import {
  ...
  FileBarChart, AlertTriangle, Repeat, CalendarCheck, CalendarPlus, Sparkles,
  Sliders, ClipboardCheck, HelpCircle, UserCog, ShieldCheck, Bell, User,
  LogOut, Search, Menu, X, ChevronLeft, ChevronRight, Heart,
} from "lucide-react";
...
const managerNav: NavGroup[] = [
  ...
  { label: "Reports", items: [
    { label: "Reports & Analytics", to: "/manager/reports", icon: FileBarChart },
  ]},
    ...
    <Link to="/" className="flex items-center gap-2 px-4 py-4">
      ...
      {!collapsed && (
        <div className="flex flex-col">
          ...
          <span className="text-[11px] text-muted-foreground">Care for your team</span>
        </div>
      )}
    </Link>
  );
      ...
      <div className="flex min-w-0 flex-1 flex-col">
        ...
        <header className="sticky top-0 z-30 flex h-16 items-center gap-3 border-b border-border bg-background/80 px-4 backdrop-blur-md sm:px-6">
          ...
          <div className="relative hidden flex-1 max-w-md md:block">
            ...
            <Input placeholder="Search staff, shifts, requests…" className="pl-9" />
          </div>
